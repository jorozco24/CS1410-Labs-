...
public class Example extends JPanel implements ActionListener {
	...
	public Example() {
		...
		// Load images
		try {
			plantImage = ImageIO.read(new File("src/lab14/Animal-Icons/frog-icon.png"));
			zombieImage = ImageIO.read(new File("src/lab14/Animal-Icons/chihuahua-icon.png"));
		...
		Healer healer = new Healer(new Point2D.Double(500, 220));
